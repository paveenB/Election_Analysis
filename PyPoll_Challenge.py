...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if largest_county_name not in county_list:

            # 4b: Add the existing county to the list of counties.
            county_list.append(largest_county_name)

            # 4c: Begin tracking the county's vote count.
            county_votes_dict[largest_county_name] = 0 
        # 5: Add a vote to that county's vote count.
        county_votes_dict[largest_county_name] += 1
